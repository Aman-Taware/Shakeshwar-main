...
import { FiDownload, FiPhone, FiMail, FiMapPin, FiHome, FiCheckCircle, FiClock, FiList, FiGrid, FiInfo, FiStar, FiImage, FiArrowRight } from 'react-icons/fi';
  ...
  return (
    <div className="bg-cream min-h-screen">
      <div className="container mx-auto px-4 py-8">
        ...
        <div 
          ref={tabsRef}
          className={`flex overflow-x-auto gap-2 mb-6 pb-2 sticky-tabs ${isSticky ? 'sticky top-0 z-20 bg-cream pt-4 shadow-sm' : ''}`}
        >
          <TabButton
        ...
        <AnimatePresence mode="wait">
          ...
          >
            <div className="min-h-[400px]">
              ...
              {activeTab === 'amenities' && (
                <PropertyAmenities amenities={displayProperty.amenities} propertyId={displayProperty.id} />
              )}
      ...
      {/* Add custom styles for sticky tabs */}
      <style jsx>{`
        .sticky-tabs {
